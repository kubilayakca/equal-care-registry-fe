...
export async function generateMetadata(
  ...
  return {
    title: `${t('page_diagnostic_treatment_title')} - ${t('equalcare')}`,
    description: t('page_diagnostic_treatment_description'),
  };
}
...
export default async function Home({ params: { locale, slug } }: any) {
  ...
  return <CertificationType type={CERTIFICATION_TYPES.diagnosticTreatment} />;
}
